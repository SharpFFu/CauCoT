...
origin_model_dir = 'your_model_path/DeepSeek-R1-Distill-Qwen-32B/deepseek-ai/DeepSeek-R1-Distill-Qwen-32B'
...
TEMPLATE = open('./templates/ZR.txt').read().strip()
...
file_name = './ZR_result/R1-D-QWen-32B.jsonl'
print(file_name)
